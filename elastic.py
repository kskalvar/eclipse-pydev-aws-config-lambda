...
class ElasticSearch(object):
    ...
    def __init__(self, connections=None, log=None):
        ...
        self.log.debug("elastic: Setting up the initial connection")
    ...
    def add(self, index_name=None, doc_type=None, index_id=None, json_message=None):
        ...
        self.log.info("elastic: adding item into ES: " + str(json_message_dict))
        ...
        self.log.info("elastic: response: " + str(response.content) + "...message: " + str(response.content))
